...
async function checkExistingPost(container: Container, slug: string): Promise<boolean> {
  try {
...
async function migratePost(container: Container, post: any, authorName: string) {
  try {
